...
const SearchPage = () => {
  const [results, setResults] =  useState<{ date: string; content: string; }[]>([]); // Initialize results state as an empty array
  ...
  const handleInput = (event: CustomEvent) => {
    ...
    setResults(searchResults); // Update the results state
  };
